...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DashGreen Core dashgreen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dashgreen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dashgreen transaction") + "\n" +
                               "  dashgreen-tx [options] -create [commands]   " + _("Create hex-encoded dashgreen transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dashgreen transaction
