...
In order to support loading of multiple wallets in dashgreen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dashgreen.cpp.
...
Changes to dashgreen.cpp
----------------------
dashgreen.cpp is the entry point into dashgreen-qt, and as such, will require some minor modifications to provide hooks for
