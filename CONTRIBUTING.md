Contributing to DashGreen Core
============================

The DashGreen Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DashGreen Core project, and is not to be
confused with overall DashGreen Network Protocol consensus changes.

Whether a pull request is merged into DashGreen Core rests with the project merge
...
Patches that change DashGreen consensus rules are considerably more involved than
...
Where a patch set proposes to change the DashGreen consensus, it must have been
...
The project leader is the release manager for each DashGreen Core release.
