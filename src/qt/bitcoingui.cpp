                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DashGreen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DashGreen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dashgreen: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDASHG"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DashGreen Core"), this);
    aboutAction->setStatusTip(tr("Show information about DashGreen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DashGreen"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DashGreen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DashGreen addresses"));
    ...
    openAction->setStatusTip(tr("Open a DashGreen: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DashGreen Core help message to get a list with possible DashGreen command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DashGreen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DashGreen network", "", count));
}
...
{
    QString strTitle = tr("DashGreen Core"); // default title
...
/** Creates context menu, its actions, and dashgreens up all the relevant signals for mouse events. */
