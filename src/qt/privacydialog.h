...
public:
    ...
    void setZDashGreenControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzDASHG_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzDASHG_clicked();
    void on_pushButtonZDashGreenControl_clicked();
