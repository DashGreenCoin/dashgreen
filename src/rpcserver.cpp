...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DashGreen server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DashGreen server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DashGreen features */
        {"dashgreen", "masternode", &masternode, true, true, false},
        {"dashgreen", "listmasternodes", &listmasternodes, true, true, false},
        {"dashgreen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dashgreen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dashgreen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dashgreen", "masternodedebug", &masternodedebug, true, true, false},
        {"dashgreen", "startmasternode", &startmasternode, true, true, false},
        {"dashgreen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dashgreen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dashgreen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dashgreen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dashgreen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dashgreen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dashgreen", "mnbudget", &mnbudget, true, true, false},
        {"dashgreen", "preparebudget", &preparebudget, true, true, false},
        {"dashgreen", "submitbudget", &submitbudget, true, true, false},
        {"dashgreen", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dashgreen", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dashgreen", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dashgreen", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dashgreen", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dashgreen", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dashgreen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dashgreen", "checkbudgets", &checkbudgets, true, true, false},
        {"dashgreen", "mnsync", &mnsync, true, true, false},
        {"dashgreen", "spork", &spork, true, true, false},
        {"dashgreen", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dashgreen", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dashgreend, or the -server option to dashgreen-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dashgreen-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33223/\n";
}
