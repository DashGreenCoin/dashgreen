...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DashGreen Core"),
     ...
     * override -datadir in the dashgreen.conf file in the default data directory
     * (to be consistent with dashgreend behavior)
     */
    if (dataDir != getDefaultDataDirectory())
