...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/dashgreen-cli.cpp \
           src/dashgreen-tx.cpp \
           src/dashgreen.cpp \
           src/db.cpp \
           ...
           src/qt/dashgreen.cpp \
           src/qt/dashgreenstrings.cpp \
...
RESOURCES += src/qt/dashgreen.qrc src/qt/dashgreen_locale.qrc

TRANSLATIONS += src/qt/locale/dashgreen_bg.ts \
                src/qt/locale/dashgreen_de.ts \
                src/qt/locale/dashgreen_en.ts \
                src/qt/locale/dashgreen_es.ts \
                src/qt/locale/dashgreen_fi.ts \
                src/qt/locale/dashgreen_fr.ts \
                src/qt/locale/dashgreen_it.ts \
                src/qt/locale/dashgreen_ja.ts \
                src/qt/locale/dashgreen_pl.ts \
                src/qt/locale/dashgreen_pt.ts \
                src/qt/locale/dashgreen_ru.ts \
                src/qt/locale/dashgreen_sk.ts \
                src/qt/locale/dashgreen_sv.ts \
                src/qt/locale/dashgreen_vi.ts \
                src/qt/locale/dashgreen_zh_CN.ts \
                src/qt/locale/dashgreen_zh_TW.ts
