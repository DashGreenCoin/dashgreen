...
/** Utility functions used by the DashGreen Qt UI.
 */
namespace GUIUtil
{
...
// Render DashGreen addresses in monospace font
...
// Parse "dashgreen:" URI into recipient object, return true on successful parsing
